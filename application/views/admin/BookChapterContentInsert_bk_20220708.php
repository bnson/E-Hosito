<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Add new chapter content.</h1>
                </div>
                <div class="col-sm-6">
                            ...
                            <form action="https://ehosito.com/Book/insertBookChapterContent" method="POST" class="h-100">
                                ...
                                <div class="container-fluid h-100 d-flex flex-column">        
                                    ...
                                    <div class="row">
                                        ...
                                        <div id="pOutput" class="col h-100">
                                            ...
                                            <div class="tab-content h-100" id="pills-tabContent">
                                                <div class="tab-pane fade show active  h-100" id="pills-output" role="tabpanel" aria-labelledby="pills-output-tab">
                                                    <iframe id="iframeHtmlOutPut" class="w-100 h-100 border border-secondary rounded" sandbox="allow-downloads allow-forms allow-modals allow-pointer-lock allow-popups allow-presentation allow-same-origin allow-scripts allow-top-navigation-by-user-activation"></iframe>
                                                </div>
