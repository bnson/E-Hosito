<div class="row">
    ...
    <div class="col border m-2">
        ...
        <div id="panel-button-row-3" class="row p-0 pl-3 pr-3">            
            <div class="col-12 p-2 border rounded" style="min-height: 45px;">
                <i class="far fa-comment-dots fa-lg w-auto float-left pr-2"></i><div id="divMessage" class="float-none"></div>
            </div>
        </div>

        <div class="row p-2">
            <div id="pOne" class="col-12 col-sm-12 col-md-6 p-2">
                <textarea id="taInput" class="p-2 w-100 h-100 border rounded" maxlength="5000"></textarea>
            </div>
...
<div class="row">
    <div id="panelInformation" class="col border m-2 p-3">
        <div class="row m-0">
            ...
            <div id="divInfoVoicesSupport" class="col-12 col-sm-12 col-md-6 m-0 p-1">
