<div class="row">
    <div class="col m-2 border">
        ...
        <div class="row">
            <div class="col p-2 mb-2 border-bottom title" onclick="location.href = '/Book/filter/new'"><i class="far fa-clock"></i> SÁCH MỚI - <u>XEM THÊM</u></div>
        </div>          
...
<div class="row">
    <div class="col m-2 border">
        ...
        <div class="row">
            <div class="col p-2 mb-2 border-bottom title" onclick="location.href = '/Book/filter/genre/sgk'"><i class="fas fa-book"></i> SÁCH GIÁO KHOA - <u>XEM THÊM</u></div>
        </div>          
